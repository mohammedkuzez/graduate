...
export const useDataStore = defineStore("project", {
  ...
  actions: {
    async Projectlist() {
      try {
        const res = await fetch(
          "https://project-management-barakah.vercel.app/projects",
          {
            headers: {
    ...
    async updateProject(id, name, description, dueDate) {
      try {
        const res = await fetch(
          `https://project-management-barakah.vercel.app/projects/${id}`,
          {
            method: "PATCH",
            body: JSON.stringify({ name, description, dueDate }),
            headers: {
    ...
    async GetTasksByProjectId(projectId) {
      try {
        const res = await fetch(
          `https://project-management-barakah.vercel.app/tasks/project/${projectId}`,
          {
            method: "GET",
            headers: {
              Authorization: `Bearer ${this.token}`,
    ...
    async GetProjectById(projectId) {
      try {
        const res = await fetch(
          `https://project-management-barakah.vercel.app/projects/${projectId}`,
          {
            method: "GET",
            headers: {
              Authorization: `Bearer ${this.token}`,
    ...
    async createTask(
      ...
      try {
        const res = await fetch(
          `https://project-management-barakah.vercel.app/tasks`,
          {
            method: "POST",
            body: JSON.stringify({
              name,
    ...
    async deleteTask(id) {
      try {
        const res = await fetch(
          `https://project-management-barakah.vercel.app/tasks/${id}`,
          {
            method: "DELETE",
            headers: {
              Authorization: `Bearer ${this.token}`,
    ...
    async SendInvitation(receiverEmail, projectId) {
      try {
        const res = await fetch(
          `https://project-management-barakah.vercel.app/invitations`,
          {
            method: "POST",
    ...
    async GetInvitations() {
      try {
        ...
        this.getInvitations = this.getInvitations.filter(
    ...
    async AccesptInvitation(id) {
      try {
        const res = await fetch(
          `https://project-management-barakah.vercel.app/invitations/${id}/approve`,
          {
            method: "PATCH",
            headers: {
              Authorization: `Bearer ${this.token}`,
    ...
    async RejectInvitation(id) {
      try {
        const res = await fetch(
          `https://project-management-barakah.vercel.app/invitations/${id}/reject`,
          {
            method: "PATCH",
            headers: {
              Authorization: `Bearer ${this.token}`,
    ...
    async DashboardCharts() {
      try {
        const res = await fetch(
          `https://project-management-barakah.vercel.app/statistics`,
          {
            method: "GET",
            headers: {
              Authorization: `Bearer ${this.token}`,
